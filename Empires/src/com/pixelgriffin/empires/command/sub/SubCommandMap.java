...
public class SubCommandMap extends SubCommand {
	...
	public boolean run(CommandSender _sender, String[] _args) {
		if(_sender instanceof Player) {
			...
			String joinedName = Empires.m_playerHandler.getPlayer(invoker.getUniqueId()).getJoined().getName();//Empires.m_playerHandler.getPlayerJoinedCivilization(invoker.getUniqueId());
